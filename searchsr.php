...
.Sign-In{ margin-top:50px;  margin-right:150px; margin-left:230px;
...
$sql = "SELECT * FROM student WHERE ID = '$Empo' ";
...
&emsp;&emsp;<input type ="button" class="btn warning" value="Go To Home" onclick="window.location.href='admin.html'"><br></br>
</center>
<div>
