...
$key =$_POST['key']; 
$sql1 = "SELECT * FROM login WHERE u_id = '$key' ";
...
if (($rowcount=mysqli_num_rows($result1))==0)
  {
	echo "   <div class =\"Sign-In\">
	 ...
	 <div class=\"wrapper\"> <br><input type='button' id=\"mi\" value='TRY AGAIN'  width=\"408\" height=\"900\"  onclick=\"window.location.href='deleteu.html'\" /> <br><br></div> </div>      ";
...
$sql = "DELETE FROM login WHERE u_id ='$key'";
