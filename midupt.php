...
<div class="container">
<header>
   <h1>Updatable Teacher INFORMATION</h1>
</header>
...
$sql = "SELECT * FROM teacher WHERE ID='$check' ";
$result = mysqli_query($conn, $sql);


if (($rowcount=mysqli_num_rows($result))==0)
  {
	header("location: updatets.html");
  }
...
<table width="40%">
<tr>
<td>  ID: </td><td><input type="text"  name= "id" value=<?php echo $check?>></td>
</tr>
<tr>
<td> Teacher Name: </td><td><input type="text"  name= "nam" value=<?php echo $nam?>></td>
</tr>
<tr>
<td> Department: </td><td><input type="text"  name= "dept" value=<?php echo $dept?>></td>
</tr>
<tr>
<td> Post: </td><td><input type="text"  name= "post" value=<?php echo $post?>></td>
</tr>
<tr>
